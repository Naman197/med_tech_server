...
const QRCodeSchema = new Schema({
  ...
  orderId: { type: Schema.Types.ObjectId, ref: 'Order', required: true }, // Reference to an Order
  distributorId: { type: Schema.Types.ObjectId, ref: 'Distributor', required: true }, // Reference to a Distributor
